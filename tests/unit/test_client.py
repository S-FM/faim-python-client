...
class TestForecastClientInitialization:
    ...
    def test_initialization_with_timeout(self):
        ...
        # Timeout is passed to httpx client, can be verified via internal _timeout
        assert client._client._timeout is not None

    def test_initialization_with_empty_base_url(self):
        """Test initialization with empty base_url (no validation currently)."""
        # Note: ForecastClient doesn't validate base_url
        client = ForecastClient(base_url="")
        assert client.base_url == ""

    def test_initialization_with_invalid_url(self):
        """Test initialization with invalid base_url (no validation currently)."""
        # Note: ForecastClient doesn't validate base_url format
        client = ForecastClient(base_url="not-a-url")
        assert client.base_url == "not-a-url"

    def test_initialization_with_zero_timeout(self):
        """Test initialization with zero timeout (no validation currently)."""
        # Note: ForecastClient doesn't validate timeout value
        client = ForecastClient(base_url="https://api.example.com", timeout=0)
        assert client._client is not None

    def test_initialization_with_negative_timeout(self):
        """Test initialization with negative timeout (no validation currently)."""
        # Note: ForecastClient doesn't validate timeout value
        client = ForecastClient(base_url="https://api.example.com", timeout=-5)
        assert client._client is not None
...
class TestForecastClientForecast:
    ...
    @patch("faim_sdk.client.forecast_v1_ts_forecast_model_name_model_version_post.sync_detailed")
    def test_forecast_chronos2_point(self, mock_api):
    ...
    @patch("faim_sdk.client.forecast_v1_ts_forecast_model_name_model_version_post.sync_detailed")
    def test_forecast_chronos2_quantiles(self, mock_api):
    ...
    @patch("faim_sdk.client.forecast_v1_ts_forecast_model_name_model_version_post.sync_detailed")
    def test_forecast_flowstate(self, mock_api):
    ...
    @patch("faim_sdk.client.forecast_v1_ts_forecast_model_name_model_version_post.sync_detailed")
    def test_forecast_tirex(self, mock_api):
    ...
    @patch("faim_sdk.client.forecast_v1_ts_forecast_model_name_model_version_post.sync_detailed")
    def test_forecast_with_custom_model_version(self, mock_api):
...
class TestForecastClientErrorHandling:
    ...
    def test_validation_error_422(self, mock_api):
        ...
        mock_response.content = json.dumps(error_response.to_dict()).encode()
        mock_api.return_value = mock_response
    ...
    @patch("faim_sdk.client.forecast_v1_ts_forecast_model_name_model_version_post.sync_detailed")
    def test_insufficient_funds_error_402(self, mock_api):
    ...
    @patch("faim_sdk.client.forecast_v1_ts_forecast_model_name_model_version_post.sync_detailed")
    def test_model_not_found_error_404(self, mock_api):
    ...
    @patch("faim_sdk.client.forecast_v1_ts_forecast_model_name_model_version_post.sync_detailed")
    def test_payload_too_large_error_413(self, mock_api):
    ...
    @patch("faim_sdk.client.forecast_v1_ts_forecast_model_name_model_version_post.sync_detailed")
    def test_rate_limit_error_429(self, mock_api):
    ...
    @patch("faim_sdk.client.forecast_v1_ts_forecast_model_name_model_version_post.sync_detailed")
    def test_internal_server_error_500(self, mock_api):
    ...
    @patch("faim_sdk.client.forecast_v1_ts_forecast_model_name_model_version_post.sync_detailed")
    def test_network_error_connection_failed(self, mock_api):
    ...
    @patch("faim_sdk.client.serialize_to_arrow")
...
class TestForecastClientAsync:
    ...
    @pytest.mark.asyncio
    @patch("faim_sdk.client.forecast_v1_ts_forecast_model_name_model_version_post.asyncio_detailed")
    async def test_forecast_async_success(self, mock_api):
    ...
    @pytest.mark.asyncio
    @patch("faim_sdk.client.forecast_v1_ts_forecast_model_name_model_version_post.asyncio_detailed")
    async def test_forecast_async_validation_error(self, mock_api):
...
class TestForecastClientLogging:
    ...
    @patch("faim_sdk.client.forecast_v1_ts_forecast_model_name_model_version_post.sync_detailed")
    def test_logs_request_info(self, mock_api):
    ...
    @patch("faim_sdk.client.forecast_v1_ts_forecast_model_name_model_version_post.sync_detailed")
    def test_logs_error_info(self, mock_api):
...
class TestForecastClientIntegration:
    ...
    @patch("faim_sdk.client.forecast_v1_ts_forecast_model_name_model_version_post.sync_detailed")
    def test_multiple_requests_same_client(self, mock_api):
    ...
    @patch("faim_sdk.client.forecast_v1_ts_forecast_model_name_model_version_post.sync_detailed")
    def test_different_models_same_client(self, mock_api):
...
class TestUnivariateTransformation:
    ...
    @patch("faim_sdk.client.forecast_v1_ts_forecast_model_name_model_version_post.sync_detailed")
    def test_flowstate_multivariate_point_forecast(self, mock_api):
        ...
        with pytest.warns(UserWarning, match="(?i)flowstate.*univariate"):
            response = client.forecast(request)
    ...
    @patch("faim_sdk.client.forecast_v1_ts_forecast_model_name_model_version_post.sync_detailed")
    def test_tirex_multivariate_point_forecast(self, mock_api):
        ...
        # Execute with warning capture
        with pytest.warns(UserWarning, match="(?i)tirex.*univariate"):
            response = client.forecast(request)
    ...
    @patch("faim_sdk.client.forecast_v1_ts_forecast_model_name_model_version_post.sync_detailed")
    def test_flowstate_multivariate_quantile_forecast(self, mock_api):
    ...
    @patch("faim_sdk.client.forecast_v1_ts_forecast_model_name_model_version_post.sync_detailed")
    def test_tirex_multivariate_quantile_forecast(self, mock_api):
    ...
    @patch("faim_sdk.client.forecast_v1_ts_forecast_model_name_model_version_post.sync_detailed")
    def test_chronos2_multivariate_not_transformed(self, mock_api):
    ...
    @patch("faim_sdk.client.forecast_v1_ts_forecast_model_name_model_version_post.sync_detailed")
    def test_flowstate_univariate_not_transformed(self, mock_api):
    ...
    @patch("faim_sdk.client.forecast_v1_ts_forecast_model_name_model_version_post.asyncio_detailed")
    @pytest.mark.asyncio
    async def test_flowstate_multivariate_async(self, mock_api):
    ...
    @patch("faim_sdk.client.forecast_v1_ts_forecast_model_name_model_version_post.sync_detailed")
    def test_warning_message_content(self, mock_api):
        ...
        assert "Flowstate" in warning_message or "FlowState" in warning_message
